...
class UserAppointmentScreen extends GetWidget<AppointmentController> {
  final UserController userController;

  UserAppointmentScreen({required this.userController});
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      if (controller.isLoading.value) {
        ...
        if (controller.isLoggedIn(AppConfig.userRole)) {
          return Column(
            children: [
              Row(
              ...
              Expanded(
                child: Obx(() {
                  if(controller.isAddLoading.value) {} ///Must have this line in obx if there is no condition
                          ...
                          child: Column(
                            children: [
                              Align(
                                  ...
                                  child: Text('${appointment.name}', style: TextStyle(
                                      color: AppColor.pinkPrimary,
                              ...
                              Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text("${appointment.time}", style: TextStyle(color: AppColor.pinkPrimary)
                                  )
                              ),
                              Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text("${appointment.type}".tr, style: TextStyle(fontWeight: AppFont.wBold,color: AppColor.pinkPrimary)
                                  )
                              ),
                            ],
                          ),
                            ...
                            children: [
                              Expanded(
                                ...
                                child: Align(
                                    ...
                                    child: Text('${appointment.client == null ? 'N/A' : appointment.client!.name}', style: TextStyle(color: AppColor.pinkPrimary)
                                    )
                                ),
                              ),
                              Expanded(
                                ...
                                child: Align(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text(status['status'], style: TextStyle(fontWeight: AppFont.wMedium, color: AppColor.whiteMain)),
                                    )
                                ),
                              ),
                            ],
